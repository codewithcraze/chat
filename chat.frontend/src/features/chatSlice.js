...
const CONVERSATION_ENDPOINT = `${process.env.REACT_APP_API_ENDPOINT}/api/v1/conversation`;
const MESSAGE_ENDPOINT = `${process.env.REACT_APP_API_ENDPOINT}/api/v1/message`;
  ...
  async (values, { rejectWithValue }) => {
    ...
    try {
      const { data } = await axios.post(
        ...
        { receiverId: receiver_id, isGroup },
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
